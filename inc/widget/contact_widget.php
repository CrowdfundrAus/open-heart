...
class contactinfo extends WP_Widget {
    ...
    function contactinfo() {
        ...
        parent::__construct(false, 'themeinvento contact info', $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('contact_title')); ?>"><?php _e('Title:', 'themeinvento'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('contact_address')); ?>"><?php _e('Address 1:', 'themeinvento'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('contact_address2')); ?>"><?php _e('Address 2:', 'themeinvento'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('contact_address2')); ?>" name="<?php echo esc_attr($this->get_field_name('contact_address2')); ?>" type="text" value="<?php echo esc_attr($contact_address2); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('contact_phone')); ?>"><?php _e('Phone number:', 'themeinvento'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('contact_email')); ?>"><?php _e('Email:', 'themeinvento'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('contact_email_url')); ?>"><?php _e('Email link url:', 'themeinvento'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('contact_web')); ?>"><?php _e('Web:', 'themeinvento'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('contact_web_url')); ?>"><?php _e('Web link url:', 'themeinvento'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('contact_facebook')); ?>"><?php _e('Facebook:', 'themeinvento'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('contact_facebook_url')); ?>"><?php _e('Facebook link url:', 'themeinvento'); ?></label>
