		...
		foreach ($options as $value) {
			...
			if($smof_data){
				...
				case 'typography':
					...
					if(isset($typography_stored['face'])) {
						...
						$faces = array(
                                                                ...
                                                                $facess = array_merge($faces, $jw_googlefonts);
				...
				case 'backup':
					...
					$output .= '<p><strong>'. __('Last Backup : ','designinvento').'<span class="backup-log">'.$log.'</span></strong></p></div>'."\n";
				...
				case 'select_google_font':
					...
					$output .= '<select class="select of-input google_font_select" name="'.$value['id'].'" id="'. $value['id'] .'">';
                                        ...
                                        'Tahoma, Geneva'=>'Tahoma, Geneva',
                                        'Palatino'=>'Palatino' );
                                        $facess = array_merge($faces, $value['options']);
                                        
					foreach ($facess as $select_key => $option) {
