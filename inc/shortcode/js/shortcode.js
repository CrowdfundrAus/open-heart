    ...
    tinymce.create('tinymce.plugins.twshortcodegenerator', {
        init : function(ed, url) {
            ed.addCommand('twshortcodegenerator', function() {
                jQuery( '<div id="shortcode_container_dialog" data-current="none" />').append(jQuery('#jw-shortcode-template').html()).dialog({
...
//                    height: 500,
            ...
            ed.addButton('twshortcodegenerator', {title : 'designinvento Shortcode Generator',cmd : 'twshortcodegenerator',image : url + '/../images/iconsmall.png'})
        },
