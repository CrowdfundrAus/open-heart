function showHidePostFormatField(){    
    jQuery('#normal-sortables>[id*="jw-format-"]').each(function(){
       if(jQuery(this).attr('id').replace("jw","post")===jQuery('#post-formats-select input:radio:checked').attr('id').replace('image', '0')){
...
jQuery(function(){
    ...
    /* Select options */            
    jQuery(".jw-metaboxes select").each(function(){
        $this = jQuery(this);
    ...
    jQuery("#header_type select").change(function(){
        ...
        if( $this.val() == "subtitle" ){
            jQuery(".jw-metaboxes #subtitle").fadeIn();
			jQuery(".jw-metaboxes #videotext").fadeOut();
            jQuery(".jw-metaboxes #bg_image").fadeIn();
            jQuery(".jw-metaboxes #slider_id").fadeOut();
            jQuery(".jw-metaboxes #googlemap").fadeOut();
			jQuery(".jw-metaboxes #paralaxetext").fadeOut();
        } else if($this.val() == "slider") {
            jQuery(".jw-metaboxes #slider_id").fadeIn();
			jQuery(".jw-metaboxes #videotext").fadeOut();
            jQuery(".jw-metaboxes #subtitle").fadeOut();
            jQuery(".jw-metaboxes #bg_image").fadeOut();
            jQuery(".jw-metaboxes #googlemap").fadeOut();
			jQuery(".jw-metaboxes #paralaxetext").fadeOut();
        } else if($this.val() == "map") {
            jQuery(".jw-metaboxes #googlemap").fadeIn();
            jQuery(".jw-metaboxes #videotext").fadeIn();
            jQuery(".jw-metaboxes #slider_id").fadeOut();
            jQuery(".jw-metaboxes #subtitle").fadeOut();
            jQuery(".jw-metaboxes #bg_image").fadeOut();
			jQuery(".jw-metaboxes #paralaxetext").fadeOut();
            ...
            jQuery(".jw-metaboxes #subtitle").fadeOut();
            jQuery(".jw-metaboxes #bg_image").fadeOut();
            jQuery(".jw-metaboxes #paralaxetext").fadeIn();
        }else{
			 jQuery(".jw-metaboxes #googlemap").fadeOut();
			 jQuery(".jw-metaboxes #videotext").fadeOut();
            jQuery(".jw-metaboxes #slider_id").fadeOut();
    ...
    /* Page layout options */
    jQuery(".jw-metaboxes .type_layout a").each(function(){
        $val = jQuery(".jw-metaboxes .type_layout input").val();
        $this = jQuery(this);
        if( $this.data("value") == $val ){
            $this.addClass("active");
        }
    });
    jQuery(".jw-metaboxes .type_layout a").click(function(){
        jQuery(".jw-metaboxes .type_layout a").removeClass("active");
        $val = jQuery(this).data('value');
        jQuery(".jw-metaboxes .type_layout input").val($val);
            ...
            frame.state().get('library').on( 'remove', function() {
                var models = frame.state().get('library');
                    if(models.length == 0){
                        ...
                        jQuery.post(ajaxurl, { 
                            ids: '',
                            action: 'designinvento_save_images',
