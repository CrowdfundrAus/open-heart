...
class TWRecentPostWidget extends WP_Widget {
    function TWRecentPostWidget() {
        ...
        parent::__construct(false, 'designinvento recent posts', $widget_ops);
    }
            ...
            echo '<li>';
                ...
                if (isset($instance['theme']) && $instance['theme'] == 'post_thumbnailed') {
                    if (has_post_thumbnail($post->ID)) {
                        $lrg_img = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'medium');
                        $feat_img = $lrg_img[0];
                        $thumb_width  = "";
                        $thumb_height = "";
                ...
                echo '<div class="jw-recent-content '.$class.'">';
                    ...
                    echo '<div class="meta">';
                            _e("", "designinvento");
                            echo '<span class="date"><span class="day">'.get_the_date('j').'</span> <span class="month">'.get_the_date('M').'</span> <span class="year">'.get_the_date('Y').'</span></span><br />';
                            _e("", "designinvento");
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e("Title:", "designinvento");?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('theme')); ?>">Post theme:</label>
