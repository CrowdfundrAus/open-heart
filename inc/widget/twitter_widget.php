...
class twitterwidget extends WP_Widget {
    function twitterwidget() {
        ...
        parent::__construct(false, 'designinvento Twitter', $widget_ops);
    }
    function form($instance){ ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>">Title:</label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" value="<?php echo isset($instance['title']) ? strip_tags($instance['title']) : ''; ?>"  />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('username')); ?>">User Name:</label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('username')); ?>" name="<?php echo esc_attr($this->get_field_name('username')); ?>" value="<?php echo isset($instance['username']) ? strip_tags($instance['username']) : ''; ?>"  />
        </p>
        <p>
