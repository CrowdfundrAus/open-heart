function showHidePostFormatField(){
    ...
    jQuery('#designinvento_custom_post_format > div').each(function(){
        if(jQuery(this).hasClass('designinvento_format_'+jQuery('#post-formats-select input:radio:checked').val())){
