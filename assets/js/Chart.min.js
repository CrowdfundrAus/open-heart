...
jQuery(document).ready(function() {
    "use strict";
    // Chart Graph
    jQuery('.jw-chart-graph').each(function(){
            ...
            $datasets.push(
                {
                    ...
                    strokeColor      : $currData.attr('data-stroke-color'),
                    pointColor       : $currData.attr('data-point-color'),
                    pointStrokeColor : $currData.attr('data-point-stroke-color'),
        ...
        $curr.bind('jw-animate',function(){
            ...
            $height = ($height=='')?($curr.width()+'px'):$height;
            $canvas.attr('width', $curr.width()+'px');
    ...
    // Chart Pie
    jQuery('.jw-chart-pie').each(function(){
        var $curr = jQuery(this);
        var $type = $curr.attr('data-type');
        var $data = [];
        $curr.children('canvas').remove();
