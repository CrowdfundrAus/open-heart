...
jQuery(window).load(function() {
    ...
    //Portfolio 
    jQuery('.jw-portfolio').each(function(i){
        ...
        var $currentIsotopeContainer=$currentPortfolio.children('.row').children('.isotope-container');
         // Isotop
        showFilter($currentIsotopeContainer.closest('.row').prev('.jw-filter').children('.filters'),$currentIsotopeContainer.children('article'));
        $currentIsotopeContainer.isotope({
            itemSelector: 'article.jw_portfolio',
        ...
        $currentPortfolio.find('ul.filters').each(function() {
            ...
            $optionLinks.click(function() {
                var $container2 = jQuery(this).closest('.jw-portfolio').find('.isotope-container');
            ...
            if($currentInfinite.attr('data-has-next')==='true'&&$currentNextLink.hasClass('next')){
                ...
                jQuery.ajax({
                    ...
                    success: function(response){
                        var $newElements = jQuery(response).find('.jw-portfolio').eq(i).children('.row').children('.isotope-container').html();
                        var $newURL      = jQuery(response).find('.jw-portfolio').eq(i).find('.jw-infinite-scroll>a.next').attr('href');
                        var $hasNext     = jQuery(response).find('.jw-portfolio').eq(i).find('.jw-infinite-scroll').attr('data-has-next');
                        if($newElements){
